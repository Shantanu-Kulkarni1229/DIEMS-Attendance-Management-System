...
const { markAttendance, updateAttendance, patchAttendance, getTeacherAttendanceRecords, getTeacherDashboard, getStudentsForClassroom } = require('../controllers/teacherController');
