  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md">
      <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-md overflow-hidden border border-white p-8 relative animate-in fade-in zoom-in duration-300">
        ...
        {/* Decorative elements */}
        <div className="absolute top-[-50px] right-[-50px] w-32 h-32 bg-sky-400 rounded-full blur-3xl opacity-20 pointer-events-none"></div>
        <div className="absolute bottom-[-50px] left-[-50px] w-32 h-32 bg-blue-400 rounded-full blur-3xl opacity-20 pointer-events-none"></div>
        ...
        {!isSuccess ? (
          <>
            <div className="text-center mb-8 relative z-10">
              ...
              <h2 className="text-2xl font-bold text-slate-800">Create Your New Password</h2>
              <p className="text-sm text-slate-500 mt-2 leading-relaxed">
                For security reasons, please set a new password before accessing your student dashboard.
              </p>
            </div>
          ...
          <div className="text-center py-8 relative z-10 animate-in zoom-in duration-300">
            ...
            <p className="text-sm text-slate-500">Redirecting you to the student dashboard...</p>
          </div>
        )}
